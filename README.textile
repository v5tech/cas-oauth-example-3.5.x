...
To start quickly, build the project :<pre><code>cd cas-oauth-example-3.5.x
mvn clean install</code></pre>and start the two web applications with jetty :<pre><code>cd cas-oauth-client-example-3.5.x
